...
@app.route('/markers')
def generateMarkers():
   url = "https://hexdb.io/radar/data/aircraft.json" # aircraft.json
   ...
   for aircraft in data['aircraft']:
      ...
      if 'lat' in aircraft and 'lon' in aircraft and 'track' in aircraft and 'flight' in aircraft:
         ...
         if image_url == "n/a":
            image_url = "../static/img/image-unavailable.jpg"
         ...
         marker = {
            ...
            'track': math.trunc(aircraft['track']),
            'image': image_url,
            ...
            'speed': math.trunc(aircraft['gs']) if isinstance(aircraft.get('gs'), (int, float)) else 'N/A',
            'altitude': math.trunc(aircraft['alt_baro']) if isinstance(aircraft.get('alt_baro'), (int, float)) else 'N/A',
            'origin': route_origin,
